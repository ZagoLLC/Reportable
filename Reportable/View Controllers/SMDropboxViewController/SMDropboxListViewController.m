...
- (void)restClient:(DBRestClient *)client loadedMetadata:(DBMetadata *)metadata {
    ...
    if(filesArray.count == 0 && mode==0){
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Empty Folder" message:@"This folder does not contain Reportable compatible files" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
        [alert show];
        return;
    }
