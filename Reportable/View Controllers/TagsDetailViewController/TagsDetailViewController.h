...
,UIGestureRecognizerDelegate,UITextFieldDelegate,AVAudioPlayerDelegate,UITextViewDelegate,UICircularSliderDelegate,UIAlertViewDelegate,SMDropboxActivityDelegate,DBRestClientDelegate,SMDropboxActivityDelegate,SMDropboxViewControllerDelegate>
