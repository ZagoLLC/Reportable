...
//  Reportable
//
//  Created by Dinesh Patil on 11/5/12.did
...
- (void) showLibraryForVideo:(BOOL)isVideo;
{
    ...
    [imagePicker presentViewController:navVC animated:YES completion:NULL];
}
...
-(void)saveVideo
{
    ...
    if(filteredArray && [filteredArray count] > 0)
    {
        ...
        if(!fileName)
            do {
                fileName = [NSString stringWithFormat:@"Video %d",(int)++lastvideoID];
        ...
        // Or give first default name i.e. Video 1
        fileName =[NSString stringWithFormat:@"Video 1"];
...
- (IBAction)doneEditingButtonAction:(id)sender {
    ...
    [self.titleBar.topItem setTitle:@"REPORTABLE"];
