...
@interface SMTagsListViewController : UIViewController<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout,UITextViewDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate,AVAudioRecorderDelegate, AVAudioPlayerDelegate,SMPDFViewControlerDelegate,UIAlertViewDelegate,UITextFieldDelegate,DBRestClientDelegate,SMDropboxActivityDelegate,SMDropboxViewControllerDelegate,MFMailComposeViewControllerDelegate,SMDropboxProgressDelegate>
{
    NSMutableArray *tags;
